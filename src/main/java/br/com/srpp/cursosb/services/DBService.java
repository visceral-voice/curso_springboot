...
import br.com.srpp.cursosb.domain.PagamentoComCartao;
...
import br.com.srpp.cursosb.repositories.CategoriaRepository;
...
import br.com.srpp.cursosb.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instatiateTestDatabase() throws Exception {
		...
		Cidade cid4 = new Cidade(null, "Juiz de Fora", est1);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "rickjf2001@yahoo.com.br", "363.789.123-77",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93839393"));

		Cliente cli2 = new Cliente(null, "Sérgio Ricardo", "sergio.ricardojf@gmail.com", "123.456.789-09",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("32145507", "984135707"));
		...
		Endereco e3 = new Endereco(null, "Rua Batista de Oliveira", "1272", "Apto 202", "Centro", "36010532", cli2,
				cid4);
